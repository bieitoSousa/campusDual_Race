...
/**
 * <p>
 * Clase con métodos estáticos que usan los diferentes métodos de la clase
 * <b>Scanner</b> para obtener del usuario diferentes tipos de datos.
 * </p>
 * <p>
 * Todos los métodos funcionan igual. Reciben una cadena con el texto que se
 * mostrará para que el usuario introduzca un datos, y una cadena con el mensaje
 * para el caso de producirse algún error. Siguen pidiendo la entrada del
 * usuario hasta que sea correcta, y la devuelve cuando lo es.
 * </p>
 */
public class KeyboardReader {
	...
	public static String readString(String prompt, String messageForErrors, boolean allowEmpty) {
		...
		while (true) {
			...
			if (!StringUtils.isBlank(toret) || allowEmpty) {// need java 9
				return toret;
			} else {
